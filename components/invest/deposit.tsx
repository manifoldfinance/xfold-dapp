...
import useGetFoldAmountOut from '@/hooks/view/GetFoldAmountOut';
import useGetPoolTokens from '@/hooks/view/useGetPoolTokens';
//import useGetFoldAmountOut from "@/hooks/view/useGetFoldAmountOut";
...
export default function Deposit() {
  ...
  async function tokenDeposit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const minPoolAmountOut = foldAmountOutSingle
      ...
      <div className="space-y-4">
        {depositTokenNeedsApproval && (
          <Button onClick={approveDepositToken}>
            {`Approve Manifold Finance To Spend Your ${depositToken.symbol}`}
          </Button>
        )}
